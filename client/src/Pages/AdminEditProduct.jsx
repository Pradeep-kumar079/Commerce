...
const AdminEditProduct = () => {
  ...
  const fetchProduct = async (id) => {
    try {
      const response = await axios.get(`https://commerce-vu1b.onrender.com/api/admin/product/${id}`);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`https://commerce-vu1b.onrender.com/api/admin/modify-product/${product._id}`, product);
